...
function () {
  ...
  (0, _createClass2.default)(TreeStore, [{
    ...
    value: function appendChild(data, pid) {
      var simpleMode = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.options.simpleMode;
    ...
    value: function prependChild(node, pid) {
      ...
      if (results.length) {
        ...
        if (this.isSimpleMode()) this._updateDepth(pid);
      }
    ...
    value: function insertBefore(node, id) {
      ...
      if (results.length) {
        ...
        if (this.isSimpleMode()) this._updateDepth(results[0].pid);
      }
    ...
    key: "insertAfter",
    value: function insertAfter(node, id, simpleMode) {
